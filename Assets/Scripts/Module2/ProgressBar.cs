...
public class ProgressBar : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        new ProgressTestBar().checkUpdateLogic(slidervalue, targetProgress, FillSpeed, timedelta);
    ...
    public void IncrementProgress(float newProgress)
    {
        ...
        new ProgressTestBar().checkIncrementLogic(targetProgress, slidevalue, newProgress);
        /*targetProgress= slider.value + newProgress;*/
    }
}

public class ProgressTestBar
{
